...
import com.bezkoder.spring.datajpa.service.GeminiService;
...
public class TutorialController {
	...
	public TutorialController(GeminiService geminiservice, TutorialRepository tutorialRepository) {
	...
	// POST → Insert tutorial + process AI response
	@PostMapping("/ai")
	...
	public ResponseEntity<Tutorial> getTutorialById(@PathVariable("id") long id) {
		...
		log.info(">>> Fetching tutorial from DB for id: {}", id);
...
//	@CachePut(value = "tutorials", key = "#id")
